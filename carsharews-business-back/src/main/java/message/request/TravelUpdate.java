...
public class TravelUpdate {
    ...
    public TravelUpdate(String dispo, String voyage, String nameEvent, String typeCar,
                        String token, boolean active, City codePostal, City cityEvent, Timestamp timestamp, Timestamp timestampEnd, int occuped) {
        this.dispo = dispo;
        this.city = voyage;
        this.name = nameEvent;
